var addUserSortingNetworks = function() {
    ...
    var topSortingNetworkService = TopSortingNetworkService("#user-sn-list", "#user-sn-pills-list", false, addContextMenu);
...
var addTopOfSortingNetworks = function() {
    ...
    var topSortingNetworkService = TopSortingNetworkService("#top-sn-list", "#top-sn-pills-list", true, null);
